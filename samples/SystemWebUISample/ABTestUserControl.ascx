<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ABTestUserControl.ascx.cs" Inherits="SystemWebUISample.ABTestUserControl" %>
...
<div id="socialLoginList">
   ...
   <asp:Button id="TestUserControl" value="TestUserControl" runat="server" Text="Click Me" OnClick="TestUserControl_Click" />
