...
namespace System.Web.UI
{
    public class ScriptComponentDescriptor : ScriptDescriptor
    {
        ...
        public ScriptComponentDescriptor(string type)
        {
            ...
            {
                throw new ArgumentException(AtlasWeb.Common_NullOrEmpty, nameof(type));
            }
            _type = type;
        }
            ...
            : this(type)
        {
            ...
            {
                throw new ArgumentException(AtlasWeb.Common_NullOrEmpty, nameof(elementID));
            }
        ...
        internal string ElementIDInternal => _elementIDInternal;
        ...
        public string Type
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentException(AtlasWeb.Common_NullOrEmpty, nameof(value));
                }
                _type = value;
            }
        }
        ...
        public void AddComponentProperty(string name, string componentID)
        {
            ...
            {
                throw new ArgumentException(AtlasWeb.Common_NullOrEmpty, nameof(componentID));
            }
        ...
        public void AddEvent(string name, string handler)
        {
            ...
            {
                throw new ArgumentException(AtlasWeb.Common_NullOrEmpty, nameof(handler));
            }
            Events[name] = handler;
        }
        ...
        public void AddScriptProperty(string name, string script)
        {
            ...
            {
                throw new ArgumentException(AtlasWeb.Common_NullOrEmpty, nameof(script));
            }
        ...
        private sealed class ComponentReference : Expression
        {
            ...
            public override ExpressionType Type => ExpressionType.ComponentReference;
        ...
        private sealed class ElementReference : Expression
        {
            ...
            public override ExpressionType Type => ExpressionType.Script;
