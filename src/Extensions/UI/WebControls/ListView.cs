...
public class ListView : DataBoundControl, INamingContainer, IPageableItemContainer, IPersistedSelector, IDataKeysControl, IDataBoundListControl, IWizardSideBarListControl
{
    ...
    public virtual String GroupPlaceholderID
    {
        ...
        set
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(value), String.Format(CultureInfo.CurrentCulture, AtlasWeb.ListView_ContainerNameMustNotBeEmpty, "GroupPlaceholderID"));
            }
    ...
    public virtual String ItemPlaceholderID
    {
        ...
        set
        {
            if (String.IsNullOrEmpty(value))
            {
                throw new ArgumentOutOfRangeException(nameof(value), String.Format(CultureInfo.CurrentCulture, AtlasWeb.ListView_ContainerNameMustNotBeEmpty, "ItemPlaceholderID"));
            }
    ...
    private static int GetItemIndex(ListViewItem item, string commandArgument)
    {
        if (item != null)
        {
            ListViewDataItem dataItem = item as ListViewDataItem;
    ...
    private static bool TryGetItemIndex(ListViewItem item, string commandArgument, out int itemIndex)
    {
        if (item != null)
        {
            ListViewDataItem dataItem = item as ListViewDataItem;
