...
namespace System.Web.UI
{
    ...
    public class ScriptManager : Control, IPostBackDataHandler, IPostBackEventHandler, IControl, IScriptManager, IScriptManagerInternal
    {
        ...
        internal bool IsRestMethodCall
        {
            get
            {
                // TODO IsRestMethodCall
                Logger.LogError("IsRestMethodCall is called and defaulting to true");
                return true;
            }
        }
...
#pragma warning restore 618
        ...
        private void RegisterServices()
        {
            ...
            {
                Logger.LogWarning("EnablePageMethods requested but not implemented");
