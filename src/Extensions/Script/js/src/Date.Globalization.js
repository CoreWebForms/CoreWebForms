  ...
  for (;;) {
    ...
    switch (ar[0]) {
      ...
      case "t":
        ...
        ret.append(
          (this.getHours() < 12 ? dtf.AMDesignator : dtf.PMDesignator).charAt(
            0,
          ),
        );
        break;
      ...
      case "zz":
        ...
        hour = this.getTimezoneOffset() / 60;
        ret.append(
          (hour <= 0 ? "+" : "-") + addLeadingZero(Math.floor(Math.abs(hour))),
        );
        break;
      case "zzz":
        // Time zone offset with leading zero
