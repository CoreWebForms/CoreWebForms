...
if (document.documentElement.getBoundingClientRect) {
  Sys.UI.DomElement.getLocation = function (element) {
    ...
    var ex,
      offsetX =
        Math.round(clientRect.left) +
        (documentElement.scrollLeft || bodyElement.scrollLeft),
      offsetY =
        Math.round(clientRect.top) +
...
Sys.UI.DomElement.resolveElement = function (
  elementOrElementId,
  containerElement,
) {
...
Sys.UI.DomElement._raiseBubbleEventFromControl = function (
  control,
  source,
  args,
) {
...
Sys.UI.DomElement.getVisible = function (element) {
  ...
  var style =
    element.currentStyle || Sys.UI.DomElement._getCurrentStyle(element);
...
Sys.UI.DomElement._getCurrentStyle = function (element) {
  ...
  var computedStyle =
    w && element !== w && w.getComputedStyle
