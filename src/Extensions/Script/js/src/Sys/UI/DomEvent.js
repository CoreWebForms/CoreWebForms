...
var $removeHandler = (Sys.UI.DomEvent.removeHandler = function (
  element,
  eventName,
  handler,
) {
...
Sys.UI.DomEvent._ensureDomNode = function (element) {
  ...
  if (
    typeof element.document !== "object" &&
    element != doc &&
