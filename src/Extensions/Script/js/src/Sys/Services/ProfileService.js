...
Sys.Services._ProfileService.prototype = {
  ...
  load: function (
    ...
    if (!propertyNames) {
      ...
      parameters = {
        properties: this._clonePropertyNames(propertyNames),
  ...
  _onLoadComplete: function (result, context, methodName) {
    if (typeof result !== "object") {
      throw Error.invalidOperation(
        String.format(
          Sys.Res.webServiceInvalidReturnType,
          methodName,
          "Object",
        ),
      );
