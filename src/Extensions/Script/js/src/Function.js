...
Function.validateParameters = function (
  ...
  return Function._validateParams(
    parameters,
    expectedParameters,
    validateParameterCount,
  );
...
Function._validateParams = function (
  ...
  validateParameterCount =
    validateParameterCount || typeof validateParameterCount === "undefined";
  e = Function._validateParameterCount(
    params,
    expectedParams,
    validateParameterCount,
  );
...
Function._validateParameterType = function (
  ...
  if (
    expectedDomElement &&
    (!Sys._isDomElement(param) || param.nodeType === 3)
  ) {
