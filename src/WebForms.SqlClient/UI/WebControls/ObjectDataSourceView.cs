...
public class ObjectDataSourceView : DataSourceView, IStateManager {
    ...
    private readonly ObjectDataSource _owner;
    ...
    private Type TryGetDataObjectType() {
        ...
        //Validate with Taylor

        Type dataObjectType = Type.GetType(dataObjectTypeName, true, true);
        //= BuildManager.GetType(dataObjectTypeName, false, true);
    ...
    private sealed class ObjectDataSourceResult {
