...
public class SqlDataSource : DataSourceControl
{
    ...
    protected override DataSourceView GetView(string viewName)
    {
        ...
        {
            throw new ArgumentException(SR.GetString(SR.DataSource_InvalidViewName, ID, DefaultViewName), nameof(viewName));
        }
    ...
    internal virtual void SaveDataToCache(int startRowIndex, int maximumRows, object data, CacheDependency dependency)
    {
        ...
        CacheDependency cacheDependency = new CacheDependency([], [parentKey]);
