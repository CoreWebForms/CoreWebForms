...
internal static class SR
{
    ...
    public const string Invalid_path_for_push_promise = """Invalid path \'{0}\' for push promise. A virtual path is expected.""";
    ...
    public const string ModelDataSourceView_UseAsyncMethodMustBeUsingAsyncPage = """When using a Task-based async method, the page must be marked as asynchronous using the <%@ Page Async="true" %> directive, and the web application must be targeting .NET 4.5 or higher via <httpRuntime targetFramework="4.5" />.""";
    ...
    public const string AppVerifier_BasicInfo_NotificationInfo = """The assertion was triggered after processing notification {0}, isPostNotification = {1}, isReentry = {2}""";
    ...
    public const string AppVerifier_Errors_SyncContextSendOrPostCalledBetweenNotifications = """A thread attempted to call SynchronizationContext.Send or SynchronizationContext.Post while ASP.NET is not processing any request pipeline notification.""";
    public const string AppVerifier_Errors_SyncContextPostCalledInNestedNotification = """A thread attempted to call SynchronizationContext.Post while processing a nested request notification. This may result in undefined behavior.""";
    public const string AppVerifier_Errors_RequestNotificationCompletedSynchronouslyWithNotificationContextPending = """An inconsistency was found after processing an integrated IIS request pipeline notification. Even though the notification completed synchronously it had left pending async completions.""";
    public const string AppVerifier_Errors_NotificationContextHasChangedAfterSynchronouslyProcessingNotification = """An inconsistency was found after processing an integrated IIS request pipeline notification. The NotificationContext has unexpectedly changed while synchronously processing a notification.""";
    public const string AppVerifier_Errors_PendingProcessRequestNotificationStatusAfterCompletingNestedNotification = """An inconsistency was found after processing an integrated IIS request pipeline notification. Nested notifications such as RQ_SEND_RESPONSE have to be processed synchronously and can not leave pending async work.""";
    public const string Request_Queue_Limit_Per_Session_Exceeded = """The request queue limit of the session is exceeded.""";
    public const string MembershipPasswordFormat_Obsoleted = """Unsecured Passwords Format Detected. The Membership Provider that contains the unsecure passwords format is: {0}. The obsoleted password format is: {1}. For more information, see https://go.microsoft.com/fwlink/?linkid=834784.""";
    public const string Unhandled_Monitor_Exception = """An unhandled exception occurred while executing \'{0}\' in \'{1}\'.""";
    public const string OnExecuteRequestStep_Cannot_Be_Called = """Method OnExecuteRequestStep can only be called during HttpApplication initialization or IHttpModule initialization.""";
    public const string AdditionalConfigErrorInfo = """Click here to show additional error information""";
}
