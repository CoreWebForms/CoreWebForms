...
internal static class SR
{
    ...
    public const string Auth_rule_must_have_allow_or_deny = "Authorization rule must have an<allow> or<deny> tag.";
    ...
    public const string MenuItemStyleCollection_InvalidArgument = "public const string MenuItemStyleCollection can only contain public const string MenuItemStyles.";
    ...
    public const string MenuItemCollection_InvalidArrayType = "public const string MenuItem[] expected.";
    ...
    public const string Menu_MenuItemStyle = "The style of menu items that are in the dynamic part of the menu.";
    ...
    public const string Menu_DynamicMenuItemStyle = "The style of submenus in the dynamic part.";
    ...
    public const string Menu_ExpandImageUrl = "The URL to the image that expands an item when hovered over.";
    public const string Menu_HideSelectElements = "When set to false, the menu won't hide the Select elements on the page when displaying pop-out menus. The Select elements may then appear above the pop-out menus.";
    ...
    public const string Menu_MenuItemDataBound = "Fired after a public const string MenuItem is databound.";
    ...
    public const string ObjectDataSourceView_CacheNotSupported = "The data source '{0}' only supports caching when the SelectMethod returns a DataSet or a DataTable.";
    ...
    public const string SiteMapPath_HoverStyle = "The style applied for mouse hover.";
    ...
    public const string SiteMapNode_readonly = "public const string SiteMapNode is readonly, property {0} cannot be modified.";
    public const string SiteMapNodeCollection_Invalid_Type = "Invalid value of type {0} passed in, value must be of type public const string SiteMapNode.";
    ...
    public const string XmlSiteMapProvider_remove_node_without_provider = "SiteMapNode {0} does not have a provider, cannot remove a node without a valid provider.";
    ...
    public const string XmlSiteMapProvider_Invalid_SiteMapFile = "XmlSiteMapProvider does not allow physical path {0}, use virtual path instead.";
