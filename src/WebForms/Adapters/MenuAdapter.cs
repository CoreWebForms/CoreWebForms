...
public class MenuAdapter : WebControlAdapter, IPostBackEventHandler
{
    ...
    private static void RenderStyle(HtmlTextWriter writer, WebControl control, string className, MenuItemStyle style, bool applyInlineBorder)
    {
