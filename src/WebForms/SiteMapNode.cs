...
namespace System.Web
{
    ...
    public class SiteMapNode : ICloneable, IHierarchyData, INavigateUIData
    {
        ...
        private readonly NameValueCollection _resourceKeys;
        ...
        private static VirtualPath CreateVirtualPathFromUrl(string url)
        {
                ...
                if (keys != null && keys.Length > 1)
                {
                    ...
                    if (text == null && throwIfNotFound)
                    {
                        ...
                        throw new InvalidOperationException(
                            SR.GetString("Res_not_found_with_class_and_key", keys[0], keys[1])); ;
                    }
                }
            }
