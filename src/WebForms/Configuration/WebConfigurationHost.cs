...
namespace System.Web.Configuration {
    ...
    internal sealed class WebConfigurationHost : DelegatingConfigHost, IInternalConfigWebHost {
        const string InternalHostTypeName = "System.Configuration.Internal.InternalConfigHost, " + AssemblyRef.SystemDesign;
            ...
            if (webLevel == WebLevel.Machine || virtualPath == null) {
                ...
                if (!String.IsNullOrEmpty(site)) {
                    ...
                    if (HostingEnvironment.IsHosted) {
                        ...
                        appSiteID = HostingEnvironment.ApplicationID;
                    }
        ...
        public override void Init(IInternalConfigRoot configRoot, params object[] hostInitParams) {
            ...
            _appPath = VirtualPath.CreateAllowNull(appPath);
