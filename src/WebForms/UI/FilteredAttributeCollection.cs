...
internal sealed class FilteredAttributeDictionary : IDictionary
{
    ...
    private readonly ParsedAttributeCollection _owner;
    ...
    object IDictionary.this[object key]
    {
        get
        {
            if (!(key is string))
            {
                throw new ArgumentException(SR.GetString(SR.FilteredAttributeDictionary_ArgumentMustBeString), nameof(key));
            }
        ...
        set
        {
            ...
            if (!(value is string))
            {
                throw new ArgumentException(SR.GetString(SR.FilteredAttributeDictionary_ArgumentMustBeString), nameof(value));
            }
