...
#pragma warning restore 0649
    ...
    {
        get => (ClientIDMode)flags[clientIDMode, clientIDModeOffset];
        set => flags[clientIDMode, clientIDModeOffset] = (int)value;
    }
    ...
    {
        get => (ClientIDMode)flags[effectiveClientIDMode, effectiveClientIDModeOffset];
        set => flags[effectiveClientIDMode, effectiveClientIDModeOffset] = (int)value;
    }
    ...
    internal string UniqueClientID
    {
        get
        {
            ...
            if (uniqueID != null && uniqueID.Contains(IdSeparator))
            {
    ...
    internal string StaticClientID => flags[useGeneratedID] ? String.Empty : ID ?? String.Empty;
    ...
    protected char ClientIDSeparator => ID_RENDER_SEPARATOR;
    ...
    private bool SupportsEventValidation => SupportsEventValidationAttribute.SupportsEventValidation(this.GetType());
    ...
    public virtual bool EnableTheming
    {
        ...
        set
        {
            if ((ControlState >= ControlState.FrameworkInitialized) && !DesignMode)
            {
    ...
    internal bool IsBindingContainer => this is INamingContainer && !(this is INonBindingContainer);

    protected internal bool IsChildControlStateCleared => flags[disableChildControlState];
    ...
    public virtual string SkinID
    {
        ...
        set
        {
            if (!DesignMode)
            {
                ...
                if (ControlState >= ControlState.FrameworkInitialized)
                {
    ...
    {
        get => !flags[disableViewState];
        set => SetEnableViewStateInternal(value);
    }
    ...
    {
        get => flags[viewStateNotInherited] ?
...
//#endif
    ...
    {
        get => VirtualPath.GetAppRelativeVirtualPathStringOrEmpty(TemplateControlVirtualDirectory);
    ...
    {
        add => Events.AddHandler(EventDataBinding, value);
        remove => Events.RemoveHandler(EventDataBinding, value);
    }
    ...
    {
        add => Events.AddHandler(EventInit, value);
        remove => Events.RemoveHandler(EventInit, value);
    }
    ...
    {
        add => Events.AddHandler(EventUnload, value);
        remove => Events.RemoveHandler(EventUnload, value);
    }
    ...
    internal virtual void InitRecursive(Control namingContainer)
    {
        ...
        {
            ControlState = ControlState.ChildrenInitialized; // framework also initialized
    ...
    /// </devdoc>
    protected bool HasChildViewState => ((_occasionalFields != null) &&
                    (_occasionalFields.ControlsViewState != null) &&
    ...
    internal void LoadViewStateRecursive(object savedState)
    {
        ...
        ControlState = ControlState.ViewStateLoaded;
    }
    ...
    protected internal string MapPathSecure(string virtualPath)
    {
        ...
        {
            throw new ArgumentNullException(nameof(virtualPath), SR.GetString(SR.VirtualPath_Length_Zero));
        }
    ...
    internal object SaveControlStateInternal()
    {
        ...
        if (controlState != null)
        {
            return new Pair(controlState, null);
        }
        return null;
    }
    ...
    public virtual void RenderControl(HtmlTextWriter writer)
    {
        ...
        RenderControl(writer, null);
    }

    /// <devdoc>
    ///    <para>Used for MobilePage implementation.</para>
    /// </devdoc>
    private protected void RenderControl(HtmlTextWriter writer, object adapter)
    {
    ...
    private void RenderControlInternal(HtmlTextWriter writer, object adapter)
    {
        try
        {
    ...
    internal virtual void UnloadRecursive(bool dispose)
    {
        ...
        if (IsReloadable)
        {
            ControlState = ControlState.Constructed;
        }
    }
    ...
    {
        get => (ValidateRequestMode)flags[validateRequestMode, validateRequestModeOffset];
        set => SetValidateRequestModeInternal(value, setDirty: true);
    }
    ...
    protected internal virtual StateBag ViewState
    {
        ...
        {
            if (_viewState != null)
            {   // create a StateBag on demand; WebControl makes its case sensitive
                return _viewState;
            }
    ...
    protected internal virtual void AddedControl(Control control, int index)
    {
         ...
         */
        if (ControlState >= ControlState.ChildrenInitialized)
        {
            ...
            if (control.ControlState >= ControlState.Initialized &&
            ...
            if (ControlState >= ControlState.ViewStateLoaded)
            {
    ...
    /// </devdoc>
    protected internal bool IsTrackingViewState => flags[marked];
    ...
    /// </devdoc>
    bool IDataBindingsAccessor.HasDataBindings => ((RareFields != null) && (RareFields.DataBindings != null) && (RareFields.DataBindings.Count != 0));
    ...
    private Control OwnerControl
    {
        ...
        set => RareFieldsEnsured.OwnerControl = value;
    }
