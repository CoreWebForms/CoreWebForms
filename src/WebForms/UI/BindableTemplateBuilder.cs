        ...
        foreach (object subBuilderObject in subBuilders)
        {
            ...
            if (subBuilderControlBuilder != null)
            {
                ...
                else
                {
                    ...
                    serviceContainer.AddService(typeof(IFilterResolutionService), TemplateControl);
...
{
    private readonly BuildTemplateMethod _buildTemplateMethod;
    private readonly ExtractTemplateValuesMethod _extractTemplateValuesMethod;
