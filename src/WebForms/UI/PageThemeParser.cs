...
internal class PageThemeParser : BaseTemplateParser
{
    ...
    private readonly IList _skinFileList;
    private readonly IList _cssFileList;
    private ControlBuilder _currentSkinBuilder;

    private readonly VirtualPath _virtualDirPath;
...
{
    private readonly string _themePhysicalPath;
