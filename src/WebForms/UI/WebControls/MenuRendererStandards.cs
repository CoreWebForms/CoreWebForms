...
{
    readonly List<StyleBlockStyles> _styles = new List<StyleBlockStyles>();
...
internal class StyleBlockStyles
{
    ...
    private readonly StyleBlock _styleControl;
    private readonly CssStyleCollection _styles = new CssStyleCollection();
