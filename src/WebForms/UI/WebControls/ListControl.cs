    ...
    public virtual int SelectedIndex
    {
        ...
        set
        {
            if (value < -1)
            {
                ...
                {
                    throw new ArgumentOutOfRangeException(nameof(value), SR.GetString(SR.ListControl_SelectionOutOfRange, ID, "SelectedIndex"));
                }
            }
    ...
    public virtual string SelectedValue
    {
        ...
        set
        {
            if (Items.Count != 0)
            {
                ...
                {
                    throw new ArgumentOutOfRangeException(nameof(value), SR.GetString(SR.ListControl_SelectionOutOfRange, ID, "SelectedValue"));
                }
