...
{
    private const string populateNodeScript = @"
    function TreeView_PopulateNodeDoCallBack(context,param) {
        ";
    private const string populateNodeScriptEnd = @";
    }
";
    ...
    private const string _currentSiteMapNodeDataPath = null;
    ...
    internal TreeNodeStyle GetStyle(TreeNode node)
    {
        ...
        if (!needsSelectedStyle && typedStyle != null)
        {
            return typedStyle;
        }
    ...
    private class TreeViewExpandDepthConverter : Int32Converter
    {
        ...
        private static readonly object[] expandDepthValues = { -1,
