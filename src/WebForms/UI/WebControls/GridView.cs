        ...
        if (dataBinding) {
            ...
            if (dataSource != null) {
                ...
                if ((collection == null) && (pagedDataSource.IsPagingEnabled && !pagedDataSource.IsServerPagingEnabled)) {
                    throw new HttpException("GridView_Missing_VirtualItemCount"); ///TODO
                }
            }
        }
        else {
    ...
    private bool DetermineRenderClientScript() {
        ...
        if (!_renderClientScriptValid) {
            ...
            if (EnableSortingAndPagingCallbacks && (Context != null) && (Page != null) && (Page.RequestInternal != null) /*&& Page.Request.Browser.SupportsCallback */&& !IsParentedToUpdatePanel) {
                ...
                //TODO https://github.com/twsouthwick/systemweb-adapters-ui/issues/30
                bool hasEcmaScript = true; // browserCaps.EcmaScriptVersion.Major > 0;
                bool hasDOM = true; // browserCaps.W3CDomVersion.Major > 0;
                bool isHtml4 = true;

                //TODO is Html32TextWriter needed.
