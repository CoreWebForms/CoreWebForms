...
public class Style : Component, IStateManager
{
    ...
    private readonly bool ownStateBag;
    private bool marked;
    private int setBits;
    ...
    public Unit BorderWidth
    {
        ...
        set
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(value), SR.GetString(SR.Style_InvalidBorderWidth));
            }
    ...
    public Unit Height
    {
        ...
        set
        {
            if (value.Value < 0)
            {
                throw new ArgumentOutOfRangeException(nameof(value), SR.GetString(SR.Style_InvalidHeight));
            }
    ...
    public Unit Width
    {
        ...
        set
        {
            if (value.Value < 0)
            {
                throw new ArgumentOutOfRangeException(nameof(value), SR.GetString(SR.Style_InvalidWidth));
            }
