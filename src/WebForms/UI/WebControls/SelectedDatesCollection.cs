...
namespace System.Web.UI.WebControls
{
    ...
    public sealed class SelectedDatesCollection : ICollection
    {
        ...
        /// <devdoc>
        /// <para>Gets a <see cref='DateTime' qualify='true'/> referenced by the specified ordinal index value in the collection.</para>
        /// </devdoc>
        ...
        /// <devdoc>
        /// <para>Adds the specified <see cref='DateTime'/> to the end of the collection.</para>
        /// </devdoc>
        ...
        /// <devdoc>
        /// <para>Removes all <see cref='DateTime'/> controls from the collection.</para>
        /// </devdoc>
        public void Clear()
        {
            dateList.Clear();
        ...
        /// <devdoc>
        /// <para>Returns an enumerator of all <see cref='DateTime' qualify='true'/> controls within the collection.</para>
        /// </devdoc>
        ...
        /// <devdoc>
        /// <para>Copies contents from the collection to a specified <see cref='Array' qualify='true'/> with a 
        ...
        /// <devdoc>
        /// <para>Sets the contents of the <see cref='SelectedDatesCollection'/> to span
