...
public class TableStyle : Style
{
    ...
    public virtual int CellPadding
    {
        ...
        set
        {
            if (value < -1)
            {
                throw new ArgumentOutOfRangeException(nameof(value), SR.GetString(SR.TableStyle_InvalidCellPadding));
            }
    ...
    public virtual int CellSpacing
    {
        ...
        set
        {
            if (value < -1)
            {
                throw new ArgumentOutOfRangeException(nameof(value), SR.GetString(SR.TableStyle_InvalidCellSpacing));
            }
