...
public sealed class TreeNodeCollection : ICollection, IStateManager
{
    ...
    private readonly bool _updateParent;
    ...
    void ICollection.CopyTo(Array array, int index)
    {
        ...
        {
            throw new ArgumentException(SR.GetString(SR.TreeNodeCollection_InvalidArrayType), nameof(array));
        }
    ...
    {
        private readonly TreeNodeCollection list;
        private int index;
