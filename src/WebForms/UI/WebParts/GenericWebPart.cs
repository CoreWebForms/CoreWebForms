...
namespace System.Web.UI.WebControls.WebParts
{
    ...
    public class GenericWebPart : WebPart
    {
        ...
        private readonly IWebPart _childIWebPart;
        ...
        protected internal GenericWebPart(Control control)
        {
            ...
            {
                throw new ArgumentException(SR.GetString(SR.GenericWebPart_CannotWrapWebPart), nameof(control));
            }
            if (control is BasePartialCachingControl)
            {
                throw new ArgumentException(SR.GetString(SR.GenericWebPart_CannotWrapOutputCachedControl), nameof(control));
            }
