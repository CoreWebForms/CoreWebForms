...
namespace System.Web.UI.WebControls.WebParts
{
    ...
    public class WebPartManager : Control, INamingContainer, IPersonalizable
    {
        ...
        private readonly WebPartZoneCollection _webPartZones;
        ...
        // matches the string.
        private static readonly string[] displayTitleSuffix = [
        ...
        private readonly IDictionary _partAndChildControlIDs;

        // Contains the IDs of Zones already added.  An exception is thrown if a Zone is added with
        // a duplicate ID.
        private readonly IDictionary _zoneIDs;
    ...
    zoneObject.AddWebPart(document.getElementById('{0}'), {1}, {2});";
        ...
        public virtual WebPartDisplayMode DisplayMode
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentException(SR.GetString(SR.WebPartManager_InvalidDisplayMode), nameof(value));
                }

                if (!value.IsEnabled(this))
                {
                    throw new ArgumentException(SR.GetString(SR.WebPartManager_DisabledDisplayMode), nameof(value));
                }
        ...
        public WebPart AddWebPart(WebPart webPart, WebPartZoneBase zone, int zoneIndex)
        {
            ...
            {
                throw new ArgumentException(SR.GetString(SR.WebPartManager_MustRegister), nameof(zone));
            }
            if (zoneIndex < 0)
            {
            ...
            {
                throw new ArgumentException(SR.GetString(SR.WebPartManager_AlreadyInZone), nameof(webPart));
            }
        ...
        public virtual void BeginWebPartConnecting(WebPart webPart)
        {
            ...
            if (webPart.IsClosed)
            {
                throw new ArgumentException(SR.GetString(SR.WebPartManager_CantBeginConnectingClosed), nameof(webPart));
            }
            ...
            {
                throw new ArgumentException(SR.GetString(SR.WebPartManager_AlreadyInConnect), nameof(webPart));
            }
        ...
        public virtual void BeginWebPartEditing(WebPart webPart)
        {
            ...
            if (webPart.IsClosed)
            {
                throw new ArgumentException(SR.GetString(SR.WebPartManager_CantBeginEditingClosed), nameof(webPart));
            }
            ...
            if (webPart == SelectedWebPart)
            {
                throw new ArgumentException(SR.GetString(SR.WebPartManager_AlreadyInEdit), nameof(webPart));
            }
                                            ...
                                            WebPartTransformer transformer, bool throwOnError)
        {
            ...
            {
                throw new ArgumentException(SR.GetString(SR.UnknownWebPart), nameof(provider));
            }
            ...
            {
                throw new ArgumentException(SR.GetString(SR.UnknownWebPart), nameof(consumer));
            }
            ...
            {
                throw new ArgumentNullException(nameof(consumerConnectionPoint));
            }
            ...
            {
                throw new ArgumentException(SR.GetString(SR.WebPartManager_InvalidConnectionPoint), nameof(consumerConnectionPoint));
            }
        ...
        private void CloseOrDeleteWebPart(WebPart webPart, bool delete)
        {
            ...
            if (!delete && webPart.IsClosed)
            {
                ...
                throw new ArgumentException(SR.GetString(SR.WebPartManager_AlreadyClosed), nameof(webPart));
            }
            ...
            if (delete)
            {
                if (webPart.IsStatic)
                {
                    ...
                    throw new ArgumentException(SR.GetString(SR.WebPartManager_CantDeleteStatic), nameof(webPart));
                }
                else if (webPart.IsShared && (Personalization.Scope == PersonalizationScope.User))
                {
                    // Can't delete shared part in user scope
                    throw new ArgumentException(SR.GetString(SR.WebPartManager_CantDeleteSharedInUserScope), nameof(webPart));
                }
            }
...
#endif
            Logger.LogWarning("WebParts currently do not have any default transformers");
        ...
        private static ICollection[] CreateConnectionPoints(Type type)
        {
            ...
            foreach (MethodInfo method in methods)
            {
                ...
                if (consumerAttributes.Length == 1)
                {
                    ...
                    if (method.IsPublic && method.ReturnType == typeof(void) && parameterType != null)
                    {
                        ...
                        else
                        {
                            ...
                            Object[] args = [method, parameterType, type, displayName, id, allowsMultipleConnections];
                ...
                if (providerAttributes.Length == 1)
                {
                    ...
                    if (method.IsPublic && returnType != typeof(void) && method.GetParameters().Length == 0)
                    {
                        ...
                        {
                            // The ConnectionPointType is validated in the attribute property getter
                            Object[] args = [method, returnType, type, displayName, id, allowsMultipleConnections];
            ...
            return [ new ConsumerConnectionPointCollection(consumerConnectionPoints),
        ...
        private static string CreateDisplayTitle(string title, WebPart webPart, int count)
        {
        ...
        protected virtual string CreateDynamicWebPartID(Type webPartType)
        {
            if (webPartType == null)
            {
                throw new ArgumentNullException(nameof(webPartType));
            }
        ...
        public virtual void DisconnectWebParts(WebPartConnection connection)
        {
            ...
            {
                throw new ArgumentException(SR.GetString(SR.WebPartManager_UnknownConnection), nameof(connection));
            }
        }
        ...
        public virtual void ExportWebPart(WebPart webPart, XmlWriter writer)
        {
            ...
            {
                throw new ArgumentException(SR.GetString(SR.WebPartManager_PartNotExportable), nameof(webPart));
            }
        ...
        public string GetExportUrl(WebPart webPart)
        {
            ...
            string queryString = Page.Request.AsAspNetCore().QueryString.ToString();
        ...
        public virtual void MoveWebPart(WebPart webPart, WebPartZoneBase zone, int zoneIndex)
        {
            ...
            if (webPart.Zone == null || webPart.IsClosed)
            {
                throw new ArgumentException(SR.GetString(SR.WebPartManager_MustBeInZone), nameof(webPart));
            }
        ...
        protected virtual void RegisterClientScript()
        {
            ...
            foreach (WebPartZoneBase zone in _webPartZones)
            {
                ...
                foreach (WebPart webPart in webParts)
                {
                    ...
                    zoneCode.AppendFormat(CultureInfo.InvariantCulture, ZonePartScript, webPart.WholePartID, titleBarElementReference, allowMove);
                }
        ...
        internal void RegisterZone(WebZone zone)
        {
            ...
            if (String.IsNullOrEmpty(zoneID))
            {
                throw new ArgumentException(SR.GetString(SR.WebPartManager_NoZoneID), nameof(zone));
            }
            ...
            if (webPartZone != null)
            {
                ...
                {
                    throw new ArgumentException(SR.GetString(SR.WebPartManager_AlreadyRegistered), nameof(zone));
                }
        ...
        private static bool ShouldRenderWebPartInZone(WebPart part, WebPartZoneBase zone)
        {
        ...
        private static void VerifyType(Control control)
        {
        ...
        private sealed class WebPartManagerControlCollection : ControlCollection
        {
            ...
            private readonly WebPartManager _manager;
