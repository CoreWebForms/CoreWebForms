...
namespace System.Web.UI.WebControls.WebParts
{
    public sealed class WebPartTransformerCollection : CollectionBase {
        ...
        protected override void OnValidate(object value) {
            ...
            if (value == null) {
                throw new ArgumentNullException(nameof(value), SR.GetString(SR.Collection_CantAddNull));
            }
            if (!(value is WebPartTransformer)) {
                throw new ArgumentException(SR.GetString(SR.Collection_InvalidType, "WebPartTransformer"), nameof(value));
            }
        }
