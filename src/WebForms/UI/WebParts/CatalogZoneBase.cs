...
namespace System.Web.UI.WebControls.WebParts
{
    public abstract class CatalogZoneBase : ToolZone, IPostBackDataHandler {
        ...
        private static void RenderCatalogPart(HtmlTextWriter writer, CatalogPart catalogPart, CatalogPartChrome chrome, ref bool firstCell) {
            writer.RenderBeginTag(HtmlTextWriterTag.Tr);
        ...
        protected override object SaveViewState() {
            ...
            [
                ...
                (_selectedPartLinkStyle != null) ? ((IStateManager)_selectedPartLinkStyle).SaveViewState() : null,
            ];
