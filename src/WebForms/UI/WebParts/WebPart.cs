    ...
    public abstract class WebPart : Part, IWebPart, IWebActionable, IWebEditable {
        ...
        public virtual string CatalogIconImageUrl {
            ...
            set {
                if (CrossSiteScriptingValidation.IsDangerousUrl(value)) {
                    throw new ArgumentException(SR.GetString(SR.WebPart_BadUrl, value), nameof(value));
                }
        ...
        public static void SetPersonalizationDirty(Control control) {
            ...
            if (control.Page == null) {
                throw new ArgumentException(SR.GetString(SR.PropertyCannotBeNull, "Page"), nameof(control));
            }
            ...
            if (webPart == null) {
                throw new ArgumentException(SR.GetString(SR.WebPart_NonWebPart), nameof(control));
            }
