...
namespace System.Web.UI.WebControls.WebParts
{
    ...
    public abstract class WebPartZoneBase : WebZone, IPostBackEventHandler, IWebPartMenuUser {
        ...
        protected override object SaveViewState() {
            ...
            [
                base.SaveViewState(),
                (_selectedPartChromeStyle != null) ? ((IStateManager)_selectedPartChromeStyle).SaveViewState() : null,
                ...
                (_menuLabelHoverStyle != null) ? ((IStateManager)_menuLabelHoverStyle).SaveViewState() : null,
                (_menuCheckImageStyle != null) ? ((IStateManager)_menuCheckImageStyle).SaveViewState() : null,
                (_menuVerbStyle != null) ? ((IStateManager)_menuVerbStyle).SaveViewState() : null,
                (_menuVerbHoverStyle != null) ? ((IStateManager)_menuVerbHoverStyle).SaveViewState() : null,
                ControlStyleCreated ? ((IStateManager)ControlStyle).SaveViewState() : null,
                (_titleBarVerbStyle != null) ? ((IStateManager)_titleBarVerbStyle).SaveViewState() : null,
            ];
