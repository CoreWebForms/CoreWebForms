...
namespace System.Web.UI.WebControls.WebParts
{
    ...
    public sealed class ImportCatalogPart : CatalogPart
    {
        ...
        public override WebPart GetWebPart(WebPartDescription description)
        {
            ...
            {
                throw new ArgumentException(SR.GetString(SR.CatalogPart_UnknownDescription), nameof(description));
            }
        ...
        {
            object[] myState = [base.SaveControlState(), _importedPartDescription];
