...
namespace System.Web.UI.WebControls.WebParts
{
    ...
    internal sealed class BlobPersonalizationState : PersonalizationState
    {
        ...
        private readonly bool _isPostRequest;
        ...
        public BlobPersonalizationState(WebPartManager webPartManager) : base(webPartManager)
        {
            ...
            _isPostRequest = string.Equals(webPartManager.Page.Request.HttpMethod, "post", StringComparison.OrdinalIgnoreCase);
        }
        ...
        /// are differences.
        /// </devdoc>
        private static bool CompareProperties(IDictionary newProperties, IDictionary oldProperties)
        {
            int newCount = 0;
            int oldCount = 0;
        ...
        private static string CreatePersonalizationID(string ID, string genericWebPartID)
        {
        ...
        private static string CreatePersonalizationID(Control control, WebPart associatedGenericWebPart)
        {
        ...
        private static IDictionary DeserializeData(byte[] data)
        {
            ...
            if ((data != null) && (data.Length > 0))
            {
                ...
                {
                    throw new ArgumentException(SR.GetString(SR.BlobPersonalizationState_DeserializeError), nameof(data), deserializationException);
                }
            }
