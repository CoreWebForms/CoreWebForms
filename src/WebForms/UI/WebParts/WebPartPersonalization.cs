...
namespace System.Web.UI.WebControls.WebParts
{
    ...
    public class WebPartPersonalization
    {
        ...
        private readonly WebPartManager _owner;
        ...
        private static void ApplyPersonalizationState(Control control, PersonalizationInfo info)
        {
        ...
        protected internal virtual void CopyPersonalizationState(WebPart webPartA, WebPart webPartB)
        {
            if (webPartA == null)
            {
                throw new ArgumentNullException(nameof(webPartA));
            }
            if (webPartB == null)
            {
                throw new ArgumentNullException(nameof(webPartB));
            }
            ...
            if (genericWebPartA != null && genericWebPartB != null)
            {
                ...
                {
                    throw new ArgumentException(SR.GetString(SR.PropertyCannotBeNull, "ChildControl"), nameof(webPartA));
                }
                if (childControlB == null)
                {
                    throw new ArgumentException(SR.GetString(SR.PropertyCannotBeNull, "ChildControl"), nameof(webPartB));
                }
        ...
        private static void CopyPersonalizationState(Control controlA, Control controlB)
        {
        ...
        // Helper method used by CopyPersonalizationState()
        private static PersonalizationInfo ExtractPersonalizationState(Control control)
        {
            ITrackingPersonalizable trackingPersonalizable = control as ITrackingPersonalizable;
            IPersonalizable customPersonalizable = control as IPersonalizable;
        ...
        private static void TransferToCurrentPage(Page page)
        {
            HttpRequest request = page.RequestInternal;
            if (request == null)
            {
            ...
            {
                request.AsAspNetCore().HttpContext.Response.AsSystemWeb().Redirect(path);
            }
            else
            {
