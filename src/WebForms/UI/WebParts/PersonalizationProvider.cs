...
namespace System.Web.UI.WebControls.WebParts
{
    ...
    public abstract class PersonalizationProvider : ProviderBase
    {
        ...
        /// <devdoc>
        /// </devdoc>
        private static void GetParameters(WebPartManager webPartManager, out string path, out string userName)
        {
            if (webPartManager == null)
            {
                throw new ArgumentNullException(nameof(webPartManager));
        ...
        public virtual void SavePersonalizationState(PersonalizationState state)
        {
            ...
            if (blobState == null)
            {
                throw new ArgumentException(SR.GetString(SR.PersonalizationProvider_WrongType), nameof(state));
            }
