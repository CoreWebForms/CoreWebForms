...
namespace System.Web.UI.WebControls.WebParts
{
    ...
    public abstract class ProxyWebPart : WebPart {
        ...
        private readonly string _genericWebPartID;
        ...
        protected ProxyWebPart(WebPart webPart) {
            ...
            if (genericWebPart != null) {
                ...
                if (childControl == null) {
                    throw new ArgumentException(SR.GetString(SR.PropertyCannotBeNull, "ChildControl"), nameof(webPart));
                }

                _originalID = childControl.ID;
                if (String.IsNullOrEmpty(_originalID)) {
                    throw new ArgumentException(SR.GetString(SR.PropertyCannotBeNullOrEmptyString, "ChildControl.ID"), nameof(webPart));
                }
                ...
                if (String.IsNullOrEmpty(_genericWebPartID)) {
                    throw new ArgumentException(SR.GetString(SR.PropertyCannotBeNullOrEmptyString, "ID"), nameof(webPart));
                }
