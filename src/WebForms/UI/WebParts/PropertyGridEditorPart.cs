...
namespace System.Web.UI.WebControls.WebParts
{
    public sealed class PropertyGridEditorPart : EditorPart
    {
        ...
        private static bool CanEditProperty(PropertyDescriptor property)
        {
        ...
        private static Control CreateEditorControl(PropertyDescriptor pd)
        {
        ...
        private static string GetDescription(PropertyDescriptor pd)
        {
        ...
        private static string GetDisplayName(PropertyDescriptor pd)
        {
        ...
        private static PropertyDescriptorCollection GetEditableProperties(object editableObject, bool sort)
        {
            Debug.Assert(editableObject != null);
        ...
        private static object GetEditorControlValue(Control editorControl, PropertyDescriptor pd)
        {
        ...
        private static void SyncChanges(Control control, PropertyDescriptor pd, object instance)
        {
            Type propertyType = pd.PropertyType;
            if (propertyType == typeof(bool))
            {
        ...
        private sealed class DesignModeWebPart : WebPart
        {
            ...
            public static SampleEnum EnumProperty
            {
                get
                {
