...
namespace System.Web.UI.WebControls.WebParts
{
    public class WebPartChrome {
        ...
        private readonly WebPartZoneBase _zone;

        // PERF: Cache these, since they are used on every call to FilterVerbs
        private readonly Page _page;
        private readonly bool _designMode;
        private readonly bool _personalizationEnabled;
        private readonly PersonalizationScope _personalizationScope;
        ...
        private static Style CreateChromeStyleWithBorder(Style partChromeStyle) {
            Style style = new Style();
        ...
        private static Style CreateTitleTextStyle(Style partTitleStyle) {
            Style style = new Style();
        ...
        private static Style CreateTitleStyleWithoutFontOrAlign(Style partTitleStyle) {
        ...
        protected virtual Style CreateWebPartChromeStyle(WebPart webPart, PartChromeType chromeType) {
            ...
            if ((chromeType < PartChromeType.Default) || (chromeType > PartChromeType.BorderOnly)) {
                throw new ArgumentOutOfRangeException(nameof(chromeType));
            }
        ...
        private static string GenerateDescriptionText(WebPart webPart) {
        ...
        private static string GenerateTitleText(WebPart webPart) {
        ...
        public virtual void RenderWebPart(HtmlTextWriter writer, WebPart webPart) {
            ...
            writer.AddStyleAttribute(HtmlTextWriterStyle.Padding, Zone.PartChromePadding.ToString(CultureInfo.InvariantCulture));
            writer.RenderBeginTag(HtmlTextWriterTag.Td);
