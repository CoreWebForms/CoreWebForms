...
internal static class TargetFrameworkUtil
{
    ...
    private static readonly ConcurrentDictionary<Type, MemberCache> s_memberCache = new ConcurrentDictionary<Type, MemberCache>();
...
#pragma warning restore CS0649
    ...
    private static readonly ConcurrentDictionary<Type, PropertyDescriptorCollection> s_typePropertyDescriptorCollectionDict =
        new ConcurrentDictionary<Type, PropertyDescriptorCollection>();
    private static readonly ConcurrentDictionary<object, PropertyDescriptorCollection> s_objectPropertyDescriptorCollectionDict =
        new ConcurrentDictionary<object, PropertyDescriptorCollection>();
    private static readonly ConcurrentDictionary<Type, EventDescriptorCollection> s_eventDescriptorCollectionDict =
        new ConcurrentDictionary<Type, EventDescriptorCollection>();

    private static readonly ConcurrentDictionary<Type, bool> s_isFrameworkType = new ConcurrentDictionary<Type, bool>();
