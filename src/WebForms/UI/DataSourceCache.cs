    ...
    internal class DataSourceCache : IStateManager
    {
        ...
        public virtual int Duration
        {
            ...
            set
            {
                if (value < 0)
                {
                    throw new ArgumentOutOfRangeException(nameof(value), SR.GetString(SR.DataSourceCache_InvalidDuration));
                }
        ...
        protected virtual void SaveDataToCacheInternal(string key, object data, CacheDependency dependency)
        {
            ...
            HttpRuntime.Cache.Insert(key, data, aggregateCacheDependency, utcAbsoluteExpiryTime, slidingExpiryTimeSpan);
        }
