...
public sealed class PageParser : TemplateControlParser
{
...
#endif
                throw new NotImplementedException("SmartNav is not supported");
    ...
    private static void ParseTransactionAttribute(string name, string value)
    {
#if PORT_TRANSACTIONS
