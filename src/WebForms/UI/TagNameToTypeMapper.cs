...
{
    private readonly TagNamespaceRegisterEntry _nsRegisterEntry;
...
internal class MainTagNameToTypeMapper
{
    ...
    private readonly BaseTemplateParser _parser;
    ...
    private readonly ITagNameToTypeMapper _htmlMapper = new HtmlTagNameToTypeMapper();
    ...
    private readonly TagNamespaceRegisterEntryTable _tagNamespaceRegisterEntries;
