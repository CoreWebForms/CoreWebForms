                    ...
                    if (!_settingsInitialized) {
                        ...
                        try {
                            ...
                            if (settings == null || !Boolean.TryParse(settings["aspnet:UseTaskFriendlySynchronizationContext"], out _useTaskFriendlySynchronizationContext))
                                ...
                                _useTaskFriendlySynchronizationContext = true;
                            ...
                            if (settings == null || !Boolean.TryParse(settings["aspnet:DontUsePercentUUrlEncoding"],
                                ...
                                _dontUsePercentUUrlEncoding = true; // default value is keyed off of <httpRuntime targetFramework="4.5.2" />
