...
internal abstract class BaseTemplateCodeDomTreeGenerator : BaseCodeDomTreeGenerator
{
    ...
    protected const string buildMethodPrefix = "__BuildControl";
    protected const string extractTemplateValuesMethodPrefix = "__ExtractValues";
    protected const string templateSourceDirectoryName = "AppRelativeTemplateSourceDirectory";
    protected const string applyStyleSheetMethodName = "ApplyStyleSheetSkin";
    protected const string pagePropertyName = "Page";
    ...
    private static CodeStatement GetOutputWriteStatement(CodeExpression expr, bool encode)
    {
    ...
    /// </devdoc>
    private static void AddOutputWriteStatement(CodeStatementCollection methodStatements,
                                 CodeExpression expr,
    ...
    private class EmptyResolution : IFilterResolutionService
    {
        public static IFilterResolutionService Instance { get; } = new EmptyResolution();

        int IFilterResolutionService.CompareFilters(string filter1, string filter2) => 0;

        bool IFilterResolutionService.EvaluateFilter(string filterName) => false;
    }
        ...
        bool fInTemplate, bool topLevelControlInTemplate, PropertyEntry pse, bool fControlSkin)
    {
        ...
        container.AddService(typeof(IFilterResolutionService), EmptyResolution.Instance);
    ...
    private static void AddEntryBuildersToList(ICollection entries, ArrayList list)
    {
    ...
    private static string GetExpressionBuilderMethodName(string eventName, ControlBuilder builder)
    {
     ...
     */
    private static string BindingMethodName(ControlBuilder builder)
    {
    ...
    private static bool GenerateSimpleAssignmentAtDesignTime(bool tempObjectVariableDeclared, CodeStatementCollection topMethodStatements, CodeStatementCollection otherMethodStatements, string content, CodeLinePragma linePragma)
    {
     ...
     */
    private static string ExtractMethodName(ControlBuilder builder)
    {
        return extractTemplateValuesMethodPrefix + builder.ID;
    }

    private static Type GetCtrlTypeForBuilder(ControlBuilder builder, bool fTemplate)
    {
    ...
    protected static string GetMethodNameForBuilder(string prefix, ControlBuilder builder)
    {
        if (builder is RootBuilder)
        {
            return prefix + "Tree";
     ...
     *   }
     */
    private static void HandleDeviceFilterConditional(
