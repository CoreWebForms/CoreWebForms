...
internal class PageThemeCodeDomTreeGenerator : BaseTemplateCodeDomTreeGenerator
{
    ...
    private readonly Hashtable _controlSkinTypeNameCollection = new Hashtable();
    private readonly ArrayList _controlSkinBuilderEntryList = new ArrayList();

    private int _controlCount;
    private readonly CodeTypeReference _controlSkinDelegateType = new CodeTypeReference(typeof(ControlSkinDelegate));
    private readonly CodeTypeReference _controlSkinType = new CodeTypeReference(typeof(ControlSkin));

    private readonly PageThemeParser _themeParser;
