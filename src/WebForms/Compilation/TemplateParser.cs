...
#pragma warning restore 0649
    ...
    private readonly HashCodeCombiner _typeHashCode = new HashCodeCombiner();
...
private Match RunTextRegex(string text, int textPos) {
            ...
            ParsedAttributeCollection mainDirective, Encoding fileEncoding)
    {
        ...
        using (precompTargetWriter)
        {
            ...
            precompTargetWriter.Write(text.AsSpan(0, match.Index));
            ...
            foreach (DictionaryEntry entry in mainDirective)
            {
                ...
                if (StringUtil.EqualsIgnoreCase(attribName, "codefile"))
                {
                    continue;
                }

                if (StringUtil.EqualsIgnoreCase(attribName, CodeFileBaseClassAttributeName))
                {
                    continue;
                }
            ...
            precompTargetWriter.Write(text.AsSpan(match.Index + match.Length));
        }
    }
    ...
    internal static bool IsExpressionBuilderValue(string val)
    {
